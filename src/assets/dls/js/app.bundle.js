 ...
 */
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */(function(global) {/* http://prismjs.com/download.html?themes=prism-solarizedlight&languages=markup+css+clike+javascript+bash+batch+coffeescript+diff+git+json+less+jsx+sass+scss+typescript&plugins=line-numbers+toolbar+copy-to-clipboard */
            ...
            !function(){if("undefined"!=typeof self&&self.Prism&&self.document){if(!Prism.plugins.toolbar)return console.warn("Copy to Clipboard plugin loaded before Toolbar plugin."),void 0;var o=window.Clipboard||void 0;o||"function"!="function"||(o=__webpack_require__(15));var e=[];if(!o){var t=document.createElement("script"),n=document.querySelector("head");t.onload=function(){if(o=window.Clipboard)for(;e.length;)e.pop()()},t.src="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.5.8/clipboard.min.js",n.appendChild(t)}Prism.plugins.toolbar.registerButton("copy-to-clipboard",function(t){function n(){var e=new o(i,{text:function(){return t.code}});e.on("success",function(){i.textContent="Copied!",r()}),e.on("error",function(){i.textContent="Press Ctrl+C to copy",r()})}function r(){setTimeout(function(){i.textContent="Copy"},5e3)}var i=document.createElement("a");return i.textContent="Copy",o?n():e.push(n),i})}}();
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */(function($) {module.exports = function() {
            $(document).ready(function() {
                $('.side-subnav').css('display', 'none').addClass('hidden-subnav');
                selectNav(window.location.pathname);
            });

            $('#sidenav .primary').on('click', function() {
                var clicked = $(this);
                clicked.next().hasClass('hidden-subnav')? showNav(clicked, true) : hideNav(clicked, true);
            });

            function selectNav(location) {
                var navLocation, sideNav, primaryLink;

                location = location.match(/\/?[^\/]+$/);
                location = location? location[0] : '';
                location = location.replace(/^\//, '');

                navLocation = $('#sidenav a[href="' + location +'"]');   //Allows paths with or without trailing slash
                navLocation = navLocation.length? navLocation : $('#sidenav a[href="' + location +'"]');

                if(!navLocation.length) return;

                if(navLocation.hasClass('primary')) {
                    primaryLink = navLocation;
                } else {
                    navLocation.css('color', '#fff');
                    sideNav = navLocation.parentsUntil('ul.side-subnav').first().parent();
                    primaryLink = sideNav.parent().find('a.primary').first();
                }

                showNav(primaryLink);
            }

            function showNav(element, animate) {
                element.parent().parent().find('.primary.active').first().removeClass('active');
                element.addClass('active');

                if(animate) {
                    element.parents().find('.side-subnav').delay(100).slideUp(200).addClass('hidden-subnav');
                    element.parent().find('.side-subnav').delay(100).slideDown(200).removeClass('hidden-subnav');
                } else {
                    element.parents().find('.side-subnav').slideUp(0).addClass('hidden-subnav');
                    element.parent().find('.side-subnav').slideDown(0).removeClass('hidden-subnav');
                }
            }

            function hideNav(element) {
                element.parent().find('.side-subnav').delay(100).slideUp(200).addClass('hidden-subnav');
            }
        };
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */(function($) {module.exports = function() {
            ...
            $('.user-logged-item').on("click", function() {
                ...
                var clickedInside = $(event.target).hasClass('user-logged-container') || $(event.target).parents('.user-logged-container').length > 0;
                if (!clickedInside) {
            ...
            $('html').on('click', function(event) {
                var clickedInside = $(event.target).parents('.user-logged-item').length > 0;
                if(!clickedInside) {
                    $(this).find('.user-logged-container').hide();
                }
            });
        }
            /* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
// Reference: http://es5.github.io/#x15.4.4.18
        ...
        /* WEBPACK VAR INJECTION */(function($) {module.exports = function(){
            ...
            $('.code-box').each(function(index, element) {
                var contents = $(element).find('[data-highlight]').first(),
                    ...
                    button = $('<a class="button btn-block" href=""></a>').prependTo(element);
                ...
                function innerHTML(expanded, expandedText, collapsedText) {
                    var icon = expanded? 'icon-minus-basic' : 'icon-plus-basic',
                        text = expanded? expandedText : collapsedText;
                    return '<span class="btn-icon"><svg class="icon-plus-basic"><use xlink:href="#' + icon + '"></use></svg></span>' + text;
                }
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        /* WEBPACK VAR INJECTION */(function($) {var Cookies = __webpack_require__(20);

            module.exports = function() {
                $('.collapse-trigger').on('click', collapse);
                $('.expand-trigger').on('click', expand);
                ...
                function expand(event) {
                    ...
                    if ($(this).hasClass('hidden-nav')) {
                        $('#wrapper').find('#sidenav').addClass('sidebar-expanded').removeClass('sidebar-collapsed');

                        $('#wrapper').find('.navbar-static-side').animate({ width: '160px' }, 300);
                        ...
                        $('#wrapper').find('.side-nav-bar .as-label').css('display', 'inline-block');
                        $('#wrapper').find('.legal-entity').css({ "position": "relative", "left": "-160px" }).delay(200).animate({ left: "0px", height: "80px" }, 200);
                        $('#wrapper').find('.side-nav-bar .remember-active').next().css('display', 'inline-block');
                        $('#wrapper').find('.side-nav-bar .remember-active').removeClass('remember-active').addClass('active');

                        // force the item with active to show its subnav
                        $('#wrapper').find('.side-nav-bar .active').next().css('display', 'inline-block').removeClass('hidden-subnav');
                        $('#wrapper').find('.side-nav-bar>ul>li').css('width', '160px');

                        // side-subnav postion static on expand
                        $('#wrapper').find('.side-subnav').css('position', 'static');
                ...
                function collapse(event, animate) {
                    var element = $('.collapse-trigger');
                    animate = animate === false? animate: true;
                    Cookies.set('nav-configuration', 'collapsed');

                    if (element.hasClass('opened-nav')) {
                        $('#wrapper').find('#sidenav').addClass('sidebar-collapsed').removeClass('sidebar-expanded');
                        $('#wrapper').find('.legal-entity').css({ "position": "relative", "left": "0" });

                        if(animate) {
                            $('#wrapper').find('.legal-entity').animate({ left: "-160px" }, 200);
                            $('#wrapper').find('.legal-entity').animate({ height: '44px' }, 300);
                            $('#wrapper').find('.navbar-static-side').animate({ width: '44px' }, 300);
                            $('#wrapper').find('.page-wrapper').animate({ marginLeft: '44px' }, 300);
                        } else {
                            $('#wrapper').find('.legal-entity').css({ left: "-160px" }, 200);
                            $('#wrapper').find('.legal-entity').css({ height: '44px' }, 300);
                            $('#wrapper').find('.navbar-static-side').css({ width: '44px' }, 300);
                            $('#wrapper').find('.page-wrapper').css({ marginLeft: '44px' }, 300);
                        }
                        ...
                        $('#wrapper').find('.side-nav-bar .as-label').css('display', 'none');
                        $('#wrapper').find('.side-nav-bar .side-subnav').css('display', 'none');

                        // though it stays active, it will collapse the subnav - to respond to the click
                        $('#wrapper').find('.side-nav-bar .active').next().css('display', 'none').addClass('hidden-subnav');

                        // trick to kill the background when we have the collapsed state
                        $('#wrapper').find('.side-nav-bar ul').css('background', 'none');

                        animate? $('#wrapper').find('.side-nav-bar>ul>li').animate({ width: '44px' }, 300) :
                            $('#wrapper').find('.side-nav-bar>ul>li').css({ width: '44px' })

                        // side-subnav postion absolute on collapsed
                        $('#wrapper').find('.side-subnav').css({ 'position': 'absolute', 'z-index': '10', 'left': '0' });
